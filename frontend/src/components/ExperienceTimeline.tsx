        ...
        {experienceData.map((exp) => (
          <motion.div
            ...
            whileHover={{ 
              ...
              borderColor: 'rgba(139, 124, 246, 0.4)' // Subtle iris glow on hover
            }}
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-violet-50/20 dark:from-violet-900/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />

            {/* Header Info */}
            <div className="flex justify-between items-start mb-4 relative z-10">
              {/* Date Pill */}
              <span className="px-4 py-1.5 bg-iris text-ink rounded-full text-xs font-semibold tracking-wide shadow-sm shadow-iris/10">
                {exp.period}
              </span>
              ...
              <div 
                className={`w-8 h-8 rounded-full flex items-center justify-center border shadow-inner transition-all duration-300 ${
                  exp.ongoing 
                    ? 'bg-violet-50/50 dark:bg-violet-950/10 border-violet-100 dark:border-violet-900/20 text-iris' 
            ...
            {exp.certificate && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="self-start mb-4 text-[13px] font-semibold text-iris hover:text-iris-2 transition-colors relative z-10"
              >
                View certificate &#8599;
              </a>
            )}
            ...
            <div className="w-full flex flex-col gap-2 relative z-10 pt-2">
              ...
              <div className="relative w-full h-[2px] bg-slate-200 dark:bg-zinc-800">
                ...
                <motion.div 
                  className="absolute left-0 top-0 h-full bg-iris origin-left"
                  initial={{ width: '0%' }}
